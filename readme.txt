...
No. The plugin sends no email. The results of the analysis are in your panel, which you enter with a sign-in link sent to your email when you ask for one.
